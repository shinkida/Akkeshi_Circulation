# -*- coding: utf-8 -*-
"""
Created on Sat Nov  6 13:55:04 2021
...
a = pd.read_csv('E01_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D01=A[:,0]
T01=A[:,1]
S01=A[:,2]

a = pd.read_csv('E02_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D02=A[:,0]
T02=A[:,1]
S02=A[:,2]

a = pd.read_csv('E03_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D03=A[:,0]
T03=A[:,1]
S03=A[:,2]

a = pd.read_csv('E04_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D04=A[:,0]
T04=A[:,1]
S04=A[:,2]

a = pd.read_csv('E05_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D05=A[:,0]
T05=A[:,1]
S05=A[:,2]

a = pd.read_csv('E06_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D06=A[:,0]
T06=A[:,1]
S06=A[:,2]

a = pd.read_csv('E07_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D07=A[:,0]
T07=A[:,1]
S07=A[:,2]

a = pd.read_csv('E08_0913.Csv',skiprows=6, encoding="shift-jis")
A = a.to_numpy()
D08=A[:,0]
T08=A[:,1]
S08=A[:,2]
